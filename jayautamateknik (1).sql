...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2019 at 01:26 AM
...
(82, 1, 'GG,GGG', 'undefined', 'undefined', '<p>gggggggggggg</p>\n', 'haditerpal_04Nov19_00_05_05.jpg', 1, '2019-11-04 00:05:05', NULL),
(83, 2, 'CC,CXX,CCC', 'undefined', 'undefined', '<p>cxzczc</p>\n', 'haditerpal_04Nov19_00_19_43.jpg', 1, '2019-11-04 00:19:43', NULL),
...
INSERT INTO `products` (`id`, `name`, `slug`, `idmenu`, `description`, `image`, `slideshow`, `status`, `tags`, `create_date`, `modif_date`) VALUES
(31, 'Enterprise Aplication with Java', 'enterprise_aplication_with_java', 3, '<p>About About yes Update yui</p>\n', 'haditerpal_02Nov19_13_35_33.jpg', 0, 1, 'SPRING,JSP,SERVLET,SPRING,JSP,SERVLET', '2019-11-02 13:35:33', '0000-00-00 00:00:00'),
(32, 'mesin pompa', 'mesin_pompa', 4, '<p>yes coba ya</p>\n', 'haditerpal_02Nov19_17_02_02.jpg', 0, 1, 'CODEIGNITER,PHP', '2019-11-02 17:02:02', '0000-00-00 00:00:00');
...
(1, 'Printmu.com', 'admin@printmu.com', '', '', 'admin', '2016-09-03 13:12:57', '2019-10-21 02:09:06');
...
(1, 'Printmu', 'haditerpal@gmail.com', 928304982, 843098340, 934093840, 'facebook.com/printmu', '@printmu', 'Berkualitas, Cepat, Hemat', '', '', '', '2019-06-21 00:00:00', '2019-10-19 12:24:17');
...
--
ALTER TABLE `articles`
  MODIFY `idartikel` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
...
--
ALTER TABLE `kategorimenu`
  MODIFY `idmenu` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `galeri`
  ADD CONSTRAINT `galeri_ibfk_1` FOREIGN KEY (`idkategori`) REFERENCES `kategori` (`idkategori`) ON DELETE CASCADE ON UPDATE CASCADE;
