...
class Products extends CI_Controller
{
  ...
  public function create_action()
  {
    ...
    if ($slide == 1) {
      ...
      $simpan = array(
        ...
        'idmenu' => $this->input->post('idkategoriproduk'),
        'idbrand' => $this->input->post('brandshow'),
        'description' => $this->input->post('isiproduk'),
        'image' => $this->_uploadImageSlideShow(),
        'slideshow' =>  $slide,
  ...
  public function delete($id)
  {
    ...
    if ($row) {
      unlink('./assets/img/produk/' . $row->image);
